...
[![row-sum](https://img.shields.io/static/v1?label=Open%20Project&message=row%20sum&color=blue)](https://github.com/kiboschool/programming1-row-sum)
...
[![fetching-web-data](https://img.shields.io/static/v1?label=Open%20Project&message=fetching%20web%20data&color=blue)](https://github.com/kiboschool/programming1-fetching-web-data)

## Message Encode and Decode

In this exercise, you'll explore encoding and decoding messages.

[![message-encode-decode](https://img.shields.io/static/v1?label=Open%20Project&message=message%20encode%20decode&color=blue)](https://github.com/kiboschool/programming1-message-encode-decode)
